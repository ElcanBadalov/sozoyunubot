...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="Məni qrupuna əlavə et", url="https://t.me/sozgamebot?startgroup=a")
        sohbet = InlineKeyboardButton(text="Kanalımız", url="https://t.me/DWAApks")
        admin = InlineKeyboardButton(text="Məni yaradan", url="https://t.me/guliyev909")
